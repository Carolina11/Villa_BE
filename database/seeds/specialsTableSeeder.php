...
class specialsTableSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('specials')->insert([
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Bavarian Pretzels with Beer Cheese (Basket of 2)',
        'price' => '3.75',
        ...
        DB::table('specials')->insert([
        'type' => '3',
        'name' => 'Boiled Ocean Garden Shrimp by the pound',
        'price' => '10.95',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Broetchen Fleischsalat Bruschetta (4 pc)',
        'price' => '6.95',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Bruschetta with tomato, prosciutto, fresh mozzarella, and basil',
        'price' => '6.95',
        'description' => '',
        'quantity' => '',
        'pairings' => '',
        ...
        DB::table('specials')->insert([
        'type' => '1',
        'name' => 'Buffalo Tenders- half dozen with blue cheese or ranch',
        'price' => '7.95',
        'description' => '',
        'quantity' => '',
        'pairings' => '',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Cold Smoked Rainbow Trout',
        'price' => '8.75',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Coquilles et Crevettes St. Jacques',
        'price' => '9.75',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Crab Cakes with remoulade and pepper relish',
        'price' => '7.95',
        'description' => '',
        'quantity' => '',
        'pairings' => '',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Crab Stuffed Bella Mushrooms (3 to an order)',
        'price' => '6.95',
        'description' => '',
        'quantity' => '',
        'pairings' => '',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Crab Stuffed Mushrooms (4 to an order)',
        'price' => '6.95',
        'description' => '',
        'quantity' => '',
        'pairings' => '',
        ...
        DB::table('specials')->insert([
        'type' => '1',
        'name' => 'Crock of Spicy Goulasch Soup',
        'price' => '6.50',
        ...
        DB::table('specials')->insert([
        'type' => '3',
        'name' => 'Grilled Carpetbagger Steak',
        'price' => '25.95',
        ...
        DB::table('specials')->insert([
        'type' => '3',
        'name' => 'Grilled Chicken Salad Teriyaki',
        'price' => '10.95',
        ...
        DB::table('specials')->insert([
        'type' => '3',
        'name' => 'Grilled Citrus Chicken Salad',
        'price' => '11.95',
        ...
        DB::table('specials')->insert([
        'type' => '3',
        'name' => 'Ham and Lamb Dinner for Two',
        'price' => '41.95',
        ...
        DB::table('specials')->insert([
        'type' => '3',
        'name' => 'Holzfaeller Steak (Lumberjacks Pork Steak)',
        'price' => '16.90',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Marinated Herring in Sour Cream',
        'price' => '5.95',
        ...
        DB::table('specials')->insert([
        'type' => '3',
        'name' => 'Neptune and Cluck Salad Duo',
        'price' => '10.95',
        ...
        DB::table('specials')->insert([
        'type' => '5',
        'name' => 'Neuschwansteiner Lager (16.9z Flip-top)',
        'price' => '5.95',
        'description' => '',
        'quantity' => '',
        'pairings' => '',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Oysters “rock your world” Rockefeller',
        'price' => '12.95',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Prosciutto Caprese Bruschetta',
        'price' => '8.95',
        ...
        DB::table('specials')->insert([
        'type' => '3',
        'name' => 'Sahneschnitzel (Pork Rahmschnitzel)',
        'price' => '15.93',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Sauteed Crab Cake with remoulade',
        'price' => '7.95',
        'description' => '',
        'quantity' => '',
        'pairings' => '',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Seafood Stuffed Mushrooms au Gratin',
        'price' => '6.95',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Stuffed Mushrooms Florentine',
        'price' => '6.95',
        ...
        DB::table('specials')->insert([
        'type' => '2',
        'name' => 'Toasted Olive, Tomato, and Feta Bruschetta (2 pieces)',
        'price' => '3.95',
        'description' => '',
        'quantity' => '',
        'pairings' => '',
        ...
        DB::table('specials')->insert([
        'type' => '5',
        'name' => 'Warsteiner Hf liter Pilsner (keep the glass)….',
        'price' => '4.75',
